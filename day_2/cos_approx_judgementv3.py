...
def parse_args():
    ...
    parser.add_argument('xmin', nargs = 1, type=float, help = 'The minimum number inside the cosine function')
    parser.add_argument('xmax', nargs = 1, type=float, help = 'The maximum number inside the cosine function')
